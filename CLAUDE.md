...
in this file is written to travel — it is the boilerplate a project should carry in its own `CLAUDE.md` once it
installs skills from here, so copy the piece below into that project's `CLAUDE.md` / `AGENTS.md` and an agent working
