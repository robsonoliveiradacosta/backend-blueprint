...
this file is written to travel — it is the boilerplate a project should carry in its own `AGENTS.md` once it installs
skills from here, so copy the piece below into that project's `AGENTS.md` / `CLAUDE.md` and an agent working there loads
